...
export const wallpaper = async (title, page = '1') => {
...
export const wallpapercraft = async (query) => {
    return new Promise((resolve, reject) => {
...
export const trendtwit = async (country) => {
	return new Promise((resolve, reject) => {
...
export const zerochan = async (query) => {
	return new Promise((resolve, reject) => {
...
export const anoboys = async (query) => {
	return new Promise((resolve, reject) => {
...
export const cariresep = async (query) => {
	return new Promise(async (resolve, reject) => {
...
export const apksearch = async (query) => {
	return new Promise((resolve, reject) => {
...
export const happymod = async (query) => {
	return new Promise((resolve, reject) => {
...
export const artinama = async (query) => {
	return new Promise((resolve, reject) => {
...
export const wattpad = async (query) => {
	return new Promise((resolve, reject) => {
...
export const sfilesearch = async (query) => {
	return new Promise((resolve, reject) => {
...
export const devianart = async (query) => {
	return new Promise((resolve, reject) => {
...
export const konachan = async (chara) => {
	return new Promise((resolve, reject) => {
...
export const styletext = async (teks) =>  {
  return new Promise((resolve, reject) => {
...
export const ringtone = async (title) => {
  return new Promise((resolve, reject) => {
...
export const mediaumma = async (url) => {
  return new Promise((resolve, reject) => {
    axios.get(url)
      .then(({ data }) => {
        const $ = cheerio.load(data);
...
export const wikimedia = async (title, retries = 3) => {
  return new Promise((resolve, reject) => {
...
export const xdown = async (url, options = {}) => {
  try {
...
export const playstore = async (search) => {
  return new Promise(async (resolve, reject) => {
    try {
